(()=>{var E=Object.defineProperty;var b=Object.getOwnPropertySymbols;var P=Object.prototype.hasOwnProperty,M=Object.prototype.propertyIsEnumerable;var f=a=>{throw TypeError(a)};var g=(a,t,o)=>t in a?E(a,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):a[t]=o,c=(a,t)=>{for(var o in t||(t={}))P.call(t,o)&&g(a,o,t[o]);if(b)for(var o of b(t))M.call(t,o)&&g(a,o,t[o]);return a};var T=(a,t,o)=>t.has(a)||f("Cannot "+o);var y=(a,t,o)=>t.has(a)?f("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,o);var u=(a,t,o)=>(T(a,t,"access private method"),o);var w=(a,t,o)=>new Promise((l,e)=>{var d=n=>{try{i(o.next(n))}catch(s){e(s)}},_=n=>{try{i(o.throw(n))}catch(s){e(s)}},i=n=>n.done?l(n.value):Promise.resolve(n.value).then(d,_);i((o=o.apply(a,t)).next())});var k=`<button class="contactmodal__btn contactmodal__click">
    <svg 
        version="1.1" 
...
<div class="contactmodal__container">
...
.contactmodal .contactmodal__container .contactmodal__overlay--loading {
    background-color: var(--bg-color);
    font-size: 20px;
}
.contactmodal .contactmodal__container .contactmodal__overlay--success {
    background-color: var(--bg-color);
    color: #33a72a;
    font-size: 20px;
    font-weight: 700;
...
.contactmodal .contactmodal__container .contactmodal__overlay--error {
    background-color: var(--bg-color);
    color: #d41d1d;
    font-size: 20px;
    font-weight: 700;
...
.contactmodal .contactmodal__container .contactmodal__spinner {
    width: 1.5em;
    height: 1.5em;
    border-radius: 50%;
    box-shadow:
...
}`;var r,q,z,m=class{constructor(t={}){y(this,r);this.defaults={endpoint:"/contact",position:"right",name:!0,phone:!1,delay:5,values:{name:"",phone:"",email:""},token:{name:null,value:null},colors:{bg:"#ffffff",text:"#242424"},texts:{title:"Let's have a chat!",subtitle:"",namePlaceholder:"Your Name",phonePlaceholder:"Your Phone",emailPlaceholder:"Your Email",messagePlaceholder:"Your Message",successMssg:"Thanks, your message has been sent!",errorMssg:"Uh-oh... Something went wrong. Please try again later.",buttonText:"Send"}},this.options=c(c({},this.defaults),t),t.values&&(this.options.values=c(c({},this.defaults.values),t.values)),t.colors&&(this.options.colors=c(c({},this.defaults.colors),t.colors)),t.texts&&(this.options.texts=c(c({},this.defaults.texts),t.texts)),t.token&&(this.options.token=c(c({},this.defaults.token),t.token)),u(this,r,q).call(this)}toggle(){this.modal.classList.toggle("contactmodal--open")}};r=new WeakSet,q=function(){let t=k;if(Object.keys(this.options.values).forEach(e=>{t=t.replace(`{{ ${e} }}`,this.options.values[e]||"")}),Object.keys(this.options.texts).forEach(e=>{t=t.replace(`{{ ${e} }}`,this.options.texts[e]||"")}),this.modal=document.createElement("div"),this.modal.className=`contactmodal ${this.options.position}`,this.modal.innerHTML=t,this.form=this.modal.querySelector("form"),document.documentElement.style.setProperty("--bg-color",this.options.colors.bg),document.documentElement.style.setProperty("--text-color",this.options.colors.text),!this.options.name){let e=this.form.querySelector("#user_name");e.required=!1,e.parentElement.style.display="none"}if(!this.options.phone){let e=this.form.querySelector("#user_phone");e.required=!1,e.parentElement.style.display="none"}this.options.texts.subtitle||(this.modal.querySelector(".contactmodal__sub-title").style.display="none"),this.modal.querySelector(".contactmodal__btn").addEventListener("click",()=>this.toggle()),this.modal.querySelector(".contactmodal__exit").addEventListener("click",()=>this.toggle()),this.form.addEventListener("submit",e=>u(this,r,z).call(this,e));let o=document.createElement("style");o.textContent=S,document.head.appendChild(o);let l=document.createDocumentFragment();l.appendChild(this.modal),document.body.appendChild(l)},z=function(t){return w(this,null,function*(){var v,x;t.preventDefault();let o=this.form,l=this.modal.querySelector(".contactmodal__overlay--loading"),e=this.modal.querySelector(".contactmodal__overlay--success"),d=this.modal.querySelector(".contactmodal__overlay--error");l.classList.add("contactmodal__overlay--visible");let _=((v=o.querySelector("#user_name"))==null?void 0:v.value)||null,i=((x=o.querySelector("#user_phone"))==null?void 0:x.value)||null,n=o.querySelector("#user_email").value,s=o.querySelector("#user_message").value,{token:p}=this.options,L={name:_,phone:i,email:n,message:s,page:window.location.href,token:p.name&&p.value?p:null};try{let h=yield fetch(this.options.endpoint,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(L)});if(o.reset(),o.querySelector("button").blur(),l.classList.remove("contactmodal__overlay--visible"),h.ok)e.classList.add("contactmodal__overlay--visible"),setTimeout(()=>{e.classList.remove("contactmodal__overlay--visible")},this.options.delay*1e3);else throw new Error("Server responded with an error")}catch(h){console.error("Form submission error:",h),o.reset(),o.querySelector("button").blur(),l.classList.remove("contactmodal__overlay--visible"),d.classList.add("contactmodal__overlay--visible"),setTimeout(()=>{d.classList.remove("contactmodal__overlay--visible")},this.options.delay*1e3)}})};var $=m;window.ContactModal=m;})();
