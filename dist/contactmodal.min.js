(()=>{var E=Object.defineProperty;var x=Object.getOwnPropertySymbols;var P=Object.prototype.hasOwnProperty,M=Object.prototype.propertyIsEnumerable;var g=a=>{throw TypeError(a)};var b=(a,t,o)=>t in a?E(a,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):a[t]=o,c=(a,t)=>{for(var o in t||(t={}))P.call(t,o)&&b(a,o,t[o]);if(x)for(var o of x(t))M.call(t,o)&&b(a,o,t[o]);return a};var T=(a,t,o)=>t.has(a)||g("Cannot "+o);var y=(a,t,o)=>t.has(a)?g("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,o);var _=(a,t,o)=>(T(a,t,"access private method"),o);var w=(a,t,o)=>new Promise((n,e)=>{var d=l=>{try{s(o.next(l))}catch(i){e(i)}},p=l=>{try{s(o.throw(l))}catch(i){e(i)}},s=l=>l.done?n(l.value):Promise.resolve(l.value).then(d,p);s((o=o.apply(a,t)).next())});var k=`<button class="contactmodal__btn contactmodal__click">
    <svg 
        version="1.1" 
